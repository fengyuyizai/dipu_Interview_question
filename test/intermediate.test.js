...
describe('action is batch situation, config[10 - end]', () => {
  test(`test config[4], lack accessKeyID,accessKeySecret,accountName,toAddress,templateName,receiversName`, done => {
    function callback(err) {
  ...
  test(`test config[5], lack accessKeySecret, accountName, templateName, receiversName`, done => {
    function callback(err) {
  ...
  test(`test config[6], lack accountName, templateName, receiversName`, done => {
    function callback(err) {
  ...
  test(`test config[7], lack templateName, receiversName`, done => {
    function callback(err, res) {
  ...
  test(`test config[7], lack receiversName`, done => {
    function callback(err, res) {
